    ...
    <div className="p-4 md:p-8 bg-[#f8fafc] min-h-screen">
      ...
      <header className="flex justify-between items-center mb-6 md:mb-10">
        <div>
          ...
          <p className="text-slate-400 text-[12px] md:text-[13px] mt-0.5">
            February 2026
          </p>
        </div>
        <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-purple-500 flex items-center justify-center text-white font-bold text-xs shadow-sm">
          JD
        </div>
      </header>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-5 md:p-6 border-b border-gray-50 flex justify-between items-center">
          ...
          <button className="text-[11px] font-bold text-[#00a389] uppercase tracking-wider">
            View All
          </button>
        </div>
        <div className="divide-y divide-gray-50">
          {expenses.slice(0, 5).map((item, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between p-4 md:p-5 hover:bg-gray-50 transition-all"
            >
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <h5 className="text-[13px] md:text-[14px] font-bold text-slate-700 leading-none">
                    {item.title}
                  </h5>
